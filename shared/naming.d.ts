 ...
 */
export declare function parseRecordingFilename(
  filename: string,
 ...
 * @param options - Parse options (lenient: true accepts 1-digit chapters)
 */
export declare function parseImageFilename(
  filename: string,
  options?: ParseOptions
 ...
 * @param options - Parse options (lenient: true accepts 1-digit chapters)
 */
export declare function parsePromptFilename(
  filename: string,
  options?: ParseOptions
): ParsedImageAsset | null;
/**
 ...
 */
export declare function buildRecordingFilename(
  chapter: string,
  sequence: string | null,
  name: string,
  tags?: string[]
 ...
 */
export declare function buildImageFilename(
  chapter: string,
  sequence: string,
  imageOrder: string,
  variant: string | null,
 ...
 */
export declare function compareChapterSequence(
  a: {
    chapter: string;
    sequence: string;
  },
 ...
 */
export declare function compareRecordings(
  a: {
    chapter: string;
    sequence: string;
    timestamp: string;
 ...
 */
export declare function compareImageAssets(
  a: {
    chapter: string;
    sequence: string;
    imageOrder: string;
 ...
 */
export declare function findNextSequence(
  items: {
    chapter: string;
    sequence: string;
  }[],
 ...
 */
export declare function findMaxImageOrder(
  items: {
    chapter: string;
    sequence: string;
    imageOrder: string;
