...
**Structural Issues:** 6. ⚠️ Chapter gaps (01, 03, 05 - missing 02, 04) 7. ⚠️ Sequence gaps (1, 3, 7 - missing 2, 4, 5, 6) 8. ⚠️ Duplicate sequences (same chapter-sequence twice) 9. ⚠️ Non-sequential chapters (05, 03, 07, 01) 10. ⚠️ Sequence doesn't restart at 1 for each chapter

**Derivative Mismatches:** 11. 🔍 Orphaned shadows (shadow exists, no source recording) 12. 🔍 Missing shadows (source exists, no shadow) 13. 🔍 Orphaned transcripts (transcript exists, no source) 14. 🔍 Missing transcripts (source exists, no transcript) 15. 🔍 Chapter videos without source files

**State Inconsistencies:** 16. 🔍 Files in -safe folder (should be state-based now) 17. 🔍 Parked files without annotation 18. 🔍 Manifest references missing files
