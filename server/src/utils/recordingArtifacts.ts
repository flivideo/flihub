 ...
 *
 * Renaming a take fans it out across folders — the .mov itself and a transcript
 * set (FR-30). Deleting only the .mov leaves orphans behind, so both the confirmation warning and the trash operation are
